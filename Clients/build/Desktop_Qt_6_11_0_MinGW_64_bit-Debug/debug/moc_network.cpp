...
template <> constexpr inline auto network::qt_create_metaobjectdata<qt_meta_tag_ZN7networkE_t>()
{
    ...
    QtMocHelpers::StringRefStorage qt_stringData {
        "network",
        "messageRecuPourInterface",
        "",
        "message"
    };

    QtMocHelpers::UintData qt_methods {
        // Signal 'messageRecuPourInterface'
...
void network::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: _t->messageRecuPourInterface((*reinterpret_cast<std::add_pointer_t<QString>>(_a[1]))); break;
        default: ;
        }
    }
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (network::*)(QString )>(_a, &network::messageRecuPourInterface, 0))
            return;
    }
}
...
// SIGNAL 0
void network::messageRecuPourInterface(QString _t1)
{
